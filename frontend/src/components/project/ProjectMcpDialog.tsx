...
import { ProjectMcpServerList } from './ProjectMcpServerList'
...
interface ProjectMcpDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  directory: string | undefined
}

export function ProjectMcpDialog({ open, onOpenChange, directory }: ProjectMcpDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
        ...
        <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-2 sm:pb-3 shrink-0 ">
          ...
          <DialogDescription>
            Toggle MCP servers for this project
          </DialogDescription>
        </DialogHeader>
