    ...
    <TabsContent value="basics" className="mt-0 min-h-0 flex-1 overflow-y-auto pt-4 pb-5">
      <div className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_220px] sm:items-end">
          <div className="space-y-2">
            <Label htmlFor="automation-agent">Agent slug</Label>
            <Combobox
              value={agentSlug}
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Label htmlFor="automation-model">Model override</Label>
        ...
        <div className="rounded-lg border border-border bg-card p-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <InfoHint text="Auto-run this job on its automation while still allowing manual runs from the dashboard." />
            </div>
