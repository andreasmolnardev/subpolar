...
interface JobDetailTabProps {
  selectedJob: AutomationJob | undefined
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2 text-xs text-muted-foreground">
                ...
                <span className="inline-flex items-center gap-1"><CalendarClock className="h-3.5 w-3.5" /> {formatAutomationSummary(selectedJob)}</span>
              ...
              <section className="rounded-lg border border-border/60 bg-background/40 p-3 sm:p-4">
                ...
                {hasSkillMetadata(selectedJob) && (
                  ...
                  <div className="mb-3">
                    ...
                    <p className="text-sm text-muted-foreground">Stored for future automationr integrations. The current MVP does not execute against these fields yet.</p>
                  </div>
            ...
            <Card className="border-border/60 bg-background/60 shadow-none">
              ...
              <CardContent className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="font-medium break-words">{formatAutomationSummary(selectedJob)}</p>
                  {selectedJob.automationMode === 'cron' && selectedJob.cronExpression && (
