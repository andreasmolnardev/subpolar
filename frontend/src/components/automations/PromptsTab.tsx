...
import type { PromptDialog } from '@/hooks/useAutomationUrlState'
...
import { parseMarkdownTemplate } from '@/lib/automations/markdownTemplate'
              ...
              <CardContent className="flex flex-col items-center gap-4 p-8 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Create prompt templates to reuse across your automations.
                  </p>
                </div>
              </CardContent>
            </Card>
