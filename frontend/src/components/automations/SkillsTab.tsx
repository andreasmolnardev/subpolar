    ...
    <TabsContent value="skills" className="mt-0 min-h-0 flex-1 overflow-y-auto px-6 pt-4 pb-5">
      <div className="space-y-4">
        <div className="space-y-2">
          <Label>Select skills for this automation</Label>
          <p className="text-xs text-muted-foreground">
            Skills provide domain-specific instructions to the agent. Select which skills should be available when this automation runs.
          </p>
        </div>
        ...
        <div className="space-y-2">
          <Label htmlFor="automation-skill-notes">Notes</Label>
          <Textarea
            id="automation-skill-notes"
            value={skillNotes}
            onChange={(event) => onSkillNotesChange(event.target.value)}
            placeholder="Optional notes about skill usage for this automation."
