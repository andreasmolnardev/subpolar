...
export const ENV = {
  ...
  POCKETBASE: {
    URL: getEnvString('POCKETBASE_URL', DEFAULTS.POCKETBASE.URL),
    EMAIL: getEnvString('POCKETBASE_EMAIL', DEFAULTS.POCKETBASE.EMAIL),
...
export const getPiConfigFilePath = () => path.join(ENV.WORKSPACE.BASE_PATH, ENV.WORKSPACE.CONFIG_DIR, 'subpolar.json')
